...
# Parameters from Levinshtein for InGaAs       
    	variable taumax_n $::tau_SRH_e    ;# Longest lifetime of electrons for approximately 1e18 cm^-3
	variable taumax_p $::tau_SRH_h    ;# Longest lifetime of holes for approximately 1e18 cm^-3
   }
