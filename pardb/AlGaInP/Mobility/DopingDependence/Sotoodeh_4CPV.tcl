#----------------------------------------------------------------------#
# $Id: Sotoodeh.tcl,v 1.1 2008/07/07 11:42:40 sameers Exp $
#----------------------------------------------------------------------#
...
#! VALIDITY:
#! This model is valid for x=0.51 (LOOK INTO THIS)
...
namespace eval AlGaInP::DopingDependence {
    proc init {} {
	variable formula 2
