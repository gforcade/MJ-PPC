...
# Calculate Eg0(x), alpha(x) and beta(x)         
        ...
        set Eg0_Gamma_GaP 2.886
        set Eg0_X_GaP 2.35
        set Eg0_L_GaP 2.72
        set alpha_Gamma_GaP 0.0
        set beta_Gamma_GaP 0.0
        set alpha_X_GaP 5.771e-04
        set beta_X_GaP 372.0
        set alpha_L_GaP 5.771e-04
        set beta_L_GaP 372.0
        ...
        # Calculate the band gaps for GaInP at T=0K    
        variable Eg0_Gamma [expr {[::compute_ternary $::xMole $Eg0_Gamma_GaP $Eg0_Gamma_InP $K_Gamma]}]
        variable Eg0_X [expr {[::compute_ternary $::xMole $Eg0_X_GaP $Eg0_X_InP $K_X]}]
        variable Eg0_L [expr {[::compute_ternary $::xMole $Eg0_L_GaP $Eg0_L_InP $K_L]}]

        set alpha_Gamma [expr {[::compute_ternary $::xMole $alpha_Gamma_GaP $alpha_Gamma_InP $K_alpha]}]
        set alpha_X [expr {[::compute_ternary $::xMole $alpha_X_GaP $alpha_X_InP $K_alpha]}]
        set alpha_L [expr {[::compute_ternary $::xMole $alpha_L_GaP $alpha_L_InP $K_alpha]}]
        set beta_Gamma [expr {[::compute_ternary $::xMole $beta_Gamma_GaP $beta_Gamma_InP $K_beta]}]
        set beta_X [expr {[::compute_ternary $::xMole $beta_X_GaP $beta_X_InP $K_beta]}]
        set beta_L [expr {[::compute_ternary $::xMole $beta_L_GaP $beta_L_InP $K_beta]}]
