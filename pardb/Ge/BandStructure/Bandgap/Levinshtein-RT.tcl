#----------------------------------------------------------------------#
# $Id: Levinshtein-RT.tcl,v 1.2 2007/08/28 11:57:40 sameers Exp $
#----------------------------------------------------------------------#
...
#! SDEVICE:
#! REFERENCE: 
#! "Handbook series on Semiconductor Parameters: Vol I:Si, Ge, C (Diamond), GaAs, GaP, GaSb, InAs, InP", 
...
# Calculate new value of Chi at T=Tpar if substrate and cbo are defined    
    	if {[info exists ::cbo]} {
