...
#! REFERENCE: 
#! Li et al., "Physical modeling of degenerately doped compound semiconductor for high performance ...", 2006. for n-type
#! Levinshtein for p-type
#! HISTORY
#! Created on 2022/04/27 by Gavin Forcade

namespace eval InP::JainRoulston {
    proc init {} {
        variable A_n 2.25e-8            ;# [eV cm]
