...
namespace eval InP::DopingDependence {
    proc init {} {
	variable formula 2
...
# Parameters from Palankovski
        ...
        set gamma0_n -1.9
        set gamma0_p -1.2
        set mumin300_n 1120.0
        set mumin300_p 24.0
        set gamma1_n 2.0
        set gamma1_p 1.2
        set Cref300_n 4e16
        set Cref300_p 2.5e17
        set gamma3_n 3.7
        set gamma3_p 0.47
        set alpha300_n 0.6
        set alpha300_p 1.0
        ...
        if {$::temp < 200} {
            puts stderr "Warning: InP::DopingDependence::Palankovski model is valid for T >= 200"
        }
