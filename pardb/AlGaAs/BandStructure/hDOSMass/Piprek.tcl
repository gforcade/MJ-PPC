#----------------------------------------------------------------------#
# $Id: Piprek.tcl,v 1.3 2008/07/17 13:09:11 sameers Exp $
#----------------------------------------------------------------------#
...
# Calculate mole fraction dependent light hole and heavy hole masses        
        set mlh [expr {[::compute_ternary $::xMole $mlh_AlAs $mlh_GaAs]}]
        set mhh [expr {[::compute_ternary $::xMole $mhh_AlAs $mhh_GaAs]}]
