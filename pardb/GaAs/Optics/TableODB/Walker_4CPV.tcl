...
#! EXPRESSION: 
#! Temperature dependent values of wavelength, refractive index and extinction coefficient are created using GaAs.dat in Walker folder
...
#! NOTES:
#! REFERENCE:
#  The n and k values of GaAs have been stolen from Adachi's book on optical constants of crystalline and amorphous semiconductors - numerical data and graphical information (1999).
#! HISTORY:
