...
# Parameters from Levinshtein        
    	variable taumax_n 1.0e-7    ;# Longest lifetime of electrons for approximately 1e18 cm^-3
	variable taumax_p 1.0e-8    ;# Longest lifetime of holes for approximately 1e18 cm^-3
   }
