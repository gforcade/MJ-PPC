...
#! VALIDITY: 
#! This model is valid for both n-AlInP and p-AlInP
#! NOTES: 
...
# of the side binary materials is used to calculate the bandgap narrowing of AlInP
        set epsilon [expr {[::compute_ternary $::xMole $epsilon_AlP $epsilon_InP]}]
        set mc [expr {[::compute_ternary $::xMole $mc_AlP $mc_InP]}]
        set mv [expr {[::compute_ternary $::xMole $mv_AlP $mv_InP]}]
