...
#! SDEVICE:
#! REFERENCE: 
#! "Propertiess of semiconductor alloys:...", Adachi 2009
#! HISTORY:
#! Created on 2022/01/19 by Gavin Forcade

namespace eval InAlAs::hDOSMass {
    proc init {} {
# Room temperature parameters from Adachi
	set mhh [expr {$::xMole*0.36 + (1.0 - $::xMole)*0.81}]
        set mlh [expr {$::xMole*0.026 + (1.0 - $::xMole)*0.16}]
