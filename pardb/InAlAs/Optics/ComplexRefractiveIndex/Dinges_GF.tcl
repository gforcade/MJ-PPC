...
#! using the data file from Dinges data, true data (seems like the below bandgap data was off for the non GF data)
...
#! REFERENCE: 
#! HISTORY:
#! Gavin Forcade: adapted to output ComplexRefractiveIndex and NumericalTable format 2015-Jan-14

namespace eval InAlAs::ComplexRefractiveIndex {
    proc init {} {
    ...
    #---------------------------------------------------------------------------------------------------
            ...
            set dataFile $folderName/In52AlAs_GF.dat
	    puts $dataFile
#-----------------------------------------------------------------------------------------------------
...
InAlAs::ComplexRefractiveIndex::init
